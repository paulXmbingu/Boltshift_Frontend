    ...
    return (
        <div className={styles.catSection}>
            ...
            <div className={styles.featuredStoreCards}>
                <FeaturedStoreCard storeIcon={SenjesCuisines} storeLabel={`Senjes Cuisine's`} storeDescription={`Come and explore a diverse range of high-quality products across various categories, from electronics and fashion to home essentials and more.`} />
